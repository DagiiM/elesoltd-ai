...
def resume_template():
    html_code = """
        <script src="https://kit.fontawesome.com/b99e675b6e.js"></script><div class="resume">
...
def resume_instructions():
    i = """
        Avoid adding number of years of experience unless if mentioned earlier.
        Make the cv colorful. Attractive on first look. 
        You can use html and css. On the education, stick on the ones mentioned above.
        Don't be tempted to overdo on professional description. Be as short as possible.
        For skills, let them be in a list, with green circle, blue circle indent.
        For recommendations, Put them in a list in a nice format.
    """
    return i